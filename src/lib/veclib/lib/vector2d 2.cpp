...
vector2d<Gtype>::vector2d() : vect<Gtype>()
{
}

template <class Gtype>
vector2d<Gtype>::vector2d(Gtype x, Gtype y) : vect<Gtype>(x, y)
{
}

template <class Gtype>
vector2d<Gtype>::vector2d(const vector2d<Gtype>& v) : vect<Gtype>(v.x, v.y)
{
}
